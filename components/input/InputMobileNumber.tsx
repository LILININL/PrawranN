            ...
            <HStack>
              <Button
                ...
                <HStack flexDirection="row" alignItems="center" space={1}>
                  <Image style={{ width: 22, height: 22 }} source={localeSelected.image} />
          ...
          <Modal.Body px={0}>
            {localeList.map((item, index) => (
              <Box
                key={index}
                px={4}
                backgroundColor={localeSelected.code === item.code ? 'gray.50' : 'white'}>
                <TouchableOpacity activeOpacity={0.8} onPress={() => handleLocaleSelected(item)}>
                  <HStack alignItems="center" justifyContent="space-between" py={3}>
                    ...
                    <Center
                      width={6}
                      height={6}
                      backgroundColor={localeSelected.code === item.code ? 'green.500' : 'gray.100'}
                      borderRadius="full">
